...
interface FeatureListClientProps {
  initialData: PaginatedResponse<FeatureRegistry>;
...
export function FeatureListClient({
  ...
  const { data: features, total, totalPages } = initialData;
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{t('featureKey')}</TableHead>
              ...
              {features.length === 0 ? (
                ...
                features.map((feature) => (
                  <TableRow
                    ...
                    onClick={() =>
                      router.push(`${pathname}/${feature.id}`)
                    }
                  >
