...
interface ModuleListClientProps {
  initialData: PaginatedResponse<ModuleMaster>;
...
export function ModuleListClient({
  ...
  const { data: modules, total, totalPages } = initialData;
      ...
      <Card className="shadow-sm rounded-lg">
        <CardContent className="p-0">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead>{t('moduleName')}</TableHead>
                ...
                modules.map((mod) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          mod.status === 'ACTIVE' ? 'default' : 'secondary'
                        }
                      >
                        {mod.status === 'ACTIVE'
                          ? tc('active')
